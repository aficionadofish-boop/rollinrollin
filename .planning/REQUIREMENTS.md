...
- [x] **SAVE-11**: Toggleable checkboxes: "Is save magical?", enable/disable Magic Resistance detection, enable/disable Legendary Resistance detection
...
- [x] **SAVE-13**: Feature detection summary shown per creature in save results
...
- [x] **UI-01**: Active toggles across all tabs are visually highlighted to clearly indicate the current selection (e.g. DEX on Saves tab, Advantage on Attack tab)
...
| SAVE-11 | Phase 12 | Complete |
| SAVE-12 | Phase 12 | Complete |
| SAVE-13 | Phase 12 | Complete |
