...
def _extract_traits(text: str) -> list[Trait]:
    """Extract trait entries from a Homebrewery monster block's text.
...
def _extract_speed(text: str) -> str:
    """Extract speed string from the **Speed** line in a Homebrewery monster block."""
...
def parse_homebrewery(content: str) -> ParseResult:
    ...
    for block_text in monster_blocks:
        ...
        traits = _extract_traits(block_text)
        speed = _extract_speed(block_text)
